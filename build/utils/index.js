...
__export(utils_exports, {
  addProductsByAllCollections: () => addProductsByAllCollections,
  compareShopifyProductAndSizesFromPage: () => compareShopifyProductAndSizesFromPage,
  convertShopifyVariantsToSize: () => convertShopifyVariantsToSize,
  createProductObject: () => createProductObject,
  createShopifyMetafield: () => createShopifyMetafield,
  createSoldOutVariant: () => createSoldOutVariant,
  createVariantsSize: () => createVariantsSize,
  formatPageUrlWithCollection: () => formatPageUrlWithCollection,
  formatProductTitleVendor: () => formatProductTitleVendor,
  getFormattedProductInformationFromPage: () => getFormattedProductInformationFromPage,
  getProductDescriptionByCollection: () => getProductDescriptionByCollection,
  getProductImageFromPage: () => getProductImageFromPage,
  ...
  getProductsInformationBasedOnUrl: () => getProductsInformationBasedOnUrl,
  getProductsLink: () => getProductsLink,
  getVendorByProductInfo: () => getVendorByProductInfo,
...
// src/utils/addProductsByAllCollections.ts
var addProductsByAllCollections = () => {
